...
public class AddFilesHandler {
	...
	public void execute(EPartService partService, MApplication application, EModelService modelService) {
		...
		partDy.setContributionURI("bundleclass://FirstApp/views.FilesView");
		...
		partDy.setIconURI("platform:/plugin/FirstApp/src/icons/excel-icon.png");
		partDy.setLabel("ADD FILES");
