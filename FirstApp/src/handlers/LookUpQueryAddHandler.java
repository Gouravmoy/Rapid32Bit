...
public class LookUpQueryAddHandler {
	@Execute
	public void execute(EPartService partService, MApplication application, EModelService modelService) {
		MPart partDy = MBasicFactory.INSTANCE.createPart();
		partDy.setContributionURI("bundleclass://FirstApp/views.LookUpForm");
		...
		partDy.setIconURI("platform:/plugin/FirstApp/src/icons/Exit.png");
